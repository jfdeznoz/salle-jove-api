...
public class AuthController {
    ...
    public AuthResponseDto refresh(
        ...
        if (authHeader != null && authHeader.startsWith("Bearer ")) {
            return authService.getAccessTokenUsingRefreshToken(authHeader, response);
        }

        if (refreshCookie != null && !refreshCookie.isBlank()) {
            return authService.getAccessTokenUsingRefreshToken("Bearer " + refreshCookie, response);
        }
